    ...
    return (
        <main className="bg-white">
                            ...
                            <div className="space-y-10">
                                {conciergeFeatures.map((feature, i) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="text-xl font-black text-dark-blue uppercase tracking-tight mb-2">{feature.title}</h4>
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="relative z-10 space-y-6">
                                    <h3 className="text-4xl font-black text-white uppercase italic leading-none">Hospitality <br /> <span className="text-primary italic font-black">Redefined</span></h3>
                            ...
                            <div className="absolute -top-10 -right-10 bg-primary/95 backdrop-blur p-12 text-white hidden md:block shadow-2xl z-20">
                                ...
                                <span className="block text-2xl font-black italic mb-1 uppercase tracking-tighter">Hospitality</span>
                                <span className="block text-[10px] font-bold uppercase tracking-widest opacity-70">Human-Centric Tech</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-gray-50 text-dark-blue">
                <div className="container mx-auto px-6 md:px-12 lg:px-20">
                    <div className="text-center mb-16">
                        <span className="text-primary font-black uppercase tracking-[0.3em] text-sm">Beyond a Greeting</span>
                        <h2 className="text-3xl md:text-5xl font-black mt-4 uppercase">A Robust Security Asset</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {securityAssets.map((asset, i) => (
                            ...
                            >
                                ...
                                <h4 className="text-lg font-black uppercase mb-4 tracking-tighter group-hover:text-white transition-colors">{asset.title}</h4>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 md:px-12 lg:px-20">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-black text-dark-blue uppercase">Operational Advantages</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        {operationalBenefits.map((benefit, i) => (
                            ...
                            >
                                ...
                                <h4 className="text-xl font-black text-dark-blue uppercase mb-3 tracking-tight">{benefit.title}</h4>
